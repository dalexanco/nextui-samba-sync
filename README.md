...
![The list of links, each with its status](docs/screenshots/main-screen.png) ![A link syncing, showing its progress in percent](docs/screenshots/sync-running.png) ![A link's detail screen with its last sync](docs/screenshots/link-detail-screen.png)
